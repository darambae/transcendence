...
class refreshToken(APIView):
	...
	def get(self, request) :
		...
		refresh_res = request.get(f'https://access-postgresql:4000/api/token/refresh', headers={"Authorization" : f"bearer {refresh_token}", 'Host': 'access-postgresql'}, verify=False)
