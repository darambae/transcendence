...
from api.views import searchUsers, infoOtherUser, avatarOther, listennerFriends, addFriend, acceptInvite, declineInvite, deleteFriends
...
urlpatterns = [
	...
	path('user-service/deleteFriends/', deleteFriends.as_view(), name='deleteFriends'),
