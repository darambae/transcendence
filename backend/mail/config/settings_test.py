...
LOGGING = {
    ...
    'loggers': {
        ...
        # Assuming 'api' is the name of your app where views are
        'api': { # Change 'api' to your actual app name if different
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': False,
        },
    ...
    'root': {
        'handlers': ['console'],
        'level': 'WARNING', # Set root logger to a higher level to avoid excessive logs
    },
}
...
# =========================================================================
# For example, if you have celery or other background task queues,
# you might want to switch them to 'eager' mode for tests:
